...
class CalegModel extends \App\Models\BaseModel {
    ...
    public function getViewCaleg($where) {
        $sql = 'SELECT * FROM v_user_caleg' . $where;
        $result = $this->db->query($sql)->getResultArray();
        return $result;
    }

    public function deleteData() {
        $sql = 'SELECT foto FROM user_caleg WHERE id = ?';
        ...
        $result = $this->db->table('user_caleg')->delete(['id' => $_POST['id']]);
        return $result;
    }

    public function getCalegById($id) {
        $sql = 'SELECT * FROM user_caleg WHERE id = ?';
        $result = $this->db->query($sql, trim($id))->getRowArray();
        return $result;
    }

    public function getViewCalegById($id) {
        $sql = 'SELECT * FROM v_user_caleg WHERE id = ?';
        $result = $this->db->query($sql, trim($id))->getRowArray();
        return $result;
    }
