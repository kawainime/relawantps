        ...
        <form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
            <div class="tab-content" id="myTabContent">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <label class="col-sm-12 col-md-12 col-lg-3 col-xl-2 col-form-label"><?= $provinsi ?></label>
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Kota/Kabupaten</label>
                    <div class="col-sm-5">
                        <label class="col-sm-12 col-md-12 col-lg-3 col-xl-2 col-form-label"><?= $kabupaten ?></label>
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Kecamatan</label>
                    <div class="col-sm-5">
                        <label class="col-sm-12 col-md-12 col-lg-3 col-xl-2 col-form-label"><?= $kecamatan ?></label>
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Kelurahan</label>
                    <div class="col-sm-5">
                        <label class="col-sm-12 col-md-12 col-lg-3 col-xl-2 col-form-label"><?= $kelurahan ?></label>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <label class="col-sm-12 col-md-12 col-lg-3 col-xl-2 col-form-label"><?= $nama ?></label>
                    </div>
                </div>
                <div class="row mb-3">
                        ...
                        if (!empty($avatar)) {
                            echo '<div class="img-choose" style="margin:inherit;margin-bottom:10px">
									<div class="img-choose-container">
										<img src="' . $config->baseURL . '/public/images/pemilih/' . $avatar . '?r=' . time() . '"/>
