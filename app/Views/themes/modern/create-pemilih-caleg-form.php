        ...
        <form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
            <div class="tab-content" id="myTabContent">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <label class="col-form-label"><?= $caleg['provinsi'] ?></label>
...
//                        echo options(['id' => 'id_prov', 'name' => 'id_prov', 'class' => 'select2 form-control', 'required' => ''], $prov, set_value('id_prov', ''));
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <label class="col-form-label"><?= $caleg['kabupaten'] ?></label>
...
//                        echo options(['class' => 'form-control select2 kabSelect', 'name' => 'id_kab', 'id' => 'id_kab'], $optionsKab);
                ...
                <div class="row mb-3">
                    <label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Relawan</label>
                    <div class="col-sm-5">
                        <?php
                        echo options(['id' => 'id_relawan', 'name' => 'id_relawan', 'class' => 'select2 selectrelawan form-control', 'required' => ''], $relawan, set_value('id_relawan', @$idrelawan));
//                        echo options(['class' => 'form-control select2 kecSelect', 'name' => 'idDpt', 'id' => 'idDpt'], $optionsTps);
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="nama_kec" name="nama_kec" readonly=""/>
                        <input type="hidden" id="id_kec" name="id_kec" />
                        <?php
...
//                        echo options(['class' => 'form-control select2 kecSelect', 'name' => 'id_kec', 'id' => 'id_kec'], $optionsKec);
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="nama_kel" name="nama_kel" readonly=""/>
                        <input type="hidden" id="id_kel" name="id_kel" />
                        <?php
//                        $optionsKel[''] = '';
//                        echo options(['class' => 'form-control select2 kecSelect', 'name' => 'id_kel', 'id' => 'id_kel'], $optionsKel);
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="noTps" name="noTps" readonly=""/>
                        <!--<input type="hidden" id="noTps" name="noTps" />-->
                        <?php
//                        $optionsTps[''] = '';
//                        echo options(['class' => 'form-control select2 kecSelect', 'name' => 'noTps', 'id' => 'noTps'], $optionsTps);
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <?php
                        $optionsPemilih[''] = '';
                        echo options(['class' => 'form-control select2 kecSelect', 'name' => 'idDpt', 'id' => 'idDpt', 'required' => ''], $optionsPemilih);
