        ...
        <form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
            <div class="tab-content" id="myTabContent">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <label class="col-sm-12 col-md-12 col-lg-3 col-xl-2 col-form-label"><?= $relawan['provinsi'] ?></label>
                        <input type="hidden" id="id_prov" name="id_prov" value="<?= $relawan['id_prov'] ?>"/>
                        <?php
//                        echo options(['id' => 'id_prov', 'name' => 'id_prov', 'class' => 'select2 form-control', 'required' => ''], $prov, set_value('id_prov', ''));
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <label class="col-sm-12 col-md-12 col-lg-3 col-xl-2 col-form-label"><?= $relawan['kabupaten'] ?></label>
                        <input type="hidden" id="id_kab" name="id_kab" value="<?= $relawan['id_kab'] ?>"/>
                        <?php
//                        $optionsKab[''] = '';
//                        echo options(['class' => 'form-control select2 kabSelect', 'name' => 'id_kab', 'id' => 'id_kab'], $optionsKab);
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <label class="col-sm-12 col-md-12 col-lg-3 col-xl-2 col-form-label"><?= $relawan['kecamatan'] ?></label>
                        <input type="hidden" id="id_kec" name="id_kec" value="<?= $relawan['id_kec'] ?>"/>
                        <?php
...
//                        echo options(['class' => 'form-control select2 kecSelect', 'name' => 'id_kec', 'id' => 'id_kec'], $optionsKec);
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <label class="col-sm-12 col-md-12 col-lg-3 col-xl-2 col-form-label"><?= $relawan['kelurahan'] ?></label>
                        <input type="hidden" id="id_kel" name="id_kel" value="<?= $relawan['id_kel'] ?>"/>
                        <?php
//                        $optionsKel[''] = '';
//                        echo options(['class' => 'form-control select2 kecSelect', 'name' => 'id_kel', 'id' => 'id_kel'], $optionsKel);
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <label class="col-sm-12 col-md-12 col-lg-3 col-xl-2 col-form-label"><?= $relawan['noTps'] ?></label>
                        <input type="hidden" id="noTps" name="noTps" value="<?= $relawan['noTps'] ?>"/>
                        <?php
//                        $optionsTps[''] = '';
//                        echo options(['class' => 'form-control select2 kecSelect', 'name' => 'noTps', 'id' => 'noTps'], $optionsTps);
                ...
                <div class="row mb-3">
                    <label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Nama - NIK</label>
                    <div class="col-sm-5">
                        <?php
                        echo options(['id' => 'idDpt', 'name' => 'idDpt', 'class' => 'select2 form-control', 'required' => ''], $dpt, set_value('idDpt', ''));
//                        echo options(['class' => 'form-control select2 kecSelect', 'name' => 'idDpt', 'id' => 'idDpt'], $optionsTps);
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        ...
                        echo options(['class' => 'form-control select2 kecSelect', 'name' => 'status', 'id' => 'status', 'required' => ''], $optionsStatus);
                        ?>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        ...
                        echo options(['class' => 'form-control select2 kecSelect', 'name' => 'tipe', 'id' => 'tipe', 'required' => ''], $optionsTipe);
                        ?>
                    </div>
                </div>
                <!--                <div class="row mb-3">
            ...
            if (!empty($foto)) {
                $note = '';
                if (file_exists(ROOTPATH . 'public/images/pemilih/' . $foto)) {
                    $image = $config->baseURL . 'public/images/pemilih/' . $foto;
                } else {
                    $image = $config->baseURL . 'public/images/pemilih/noimage.png';
                    $note = '<small><b>Note</strong>: File <strong>public/images/pemilih/' . $foto . '</strong> tidak ditemukan</small>';
                }
